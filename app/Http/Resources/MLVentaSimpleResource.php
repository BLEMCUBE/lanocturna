...
class MLVentaSimpleResource extends JsonResource
{
	/**
	...
	public function toArray($request)
	{
		...
		$productos = collect($jOrden['order_items'] ?? [])
			->map(function ($it) {
				$ii = app(ItemService::class)->detalle($it['item']['id'], false);

				$attrItem = collect($it['item']['variation_attributes'] ?? [])
