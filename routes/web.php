...
Route::controller(ImportacionController::class)->group(function () {
	...
	Route::get('/importaciones/{id}/exportcostoreal', 'exportExcelCostoReal')->name('importaciones.exportarcostoreal')->middleware('auth');
	...
	Route::post('/importaciones/storecosto', 'importCostoReal')->name('importaciones.costoreal')->middleware('auth');
...
//ConceptoPagos
Route::controller(ConceptoPagoController::class)->prefix('concepto-pago')->name('concepto-pago.')
	->middleware('auth')->group(function () {
		Route::post('/update/{id}', 'update')->name('update');
		Route::get('/', 'index')->name('index');
		Route::get('/{id}', 'show')->name('show');
