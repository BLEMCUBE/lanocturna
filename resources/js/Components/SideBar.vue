...
<template>
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-56 h-screen pt-16 transition-transform -translate-x-full bg-primary-900 border border-primary-900 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar">
        <div class="h-full px-0 pb-4 overflow-y-auto bg-primary-900 dark:bg-gray-800 border-primary-900">
            <ul class="font-normal">
                <li @click="setMenu('inicio')">

                    <NavLinkSideBar icon-class="fas fa-home"
                        class="flex items-center px-2 py-1.5 text-md text-white rounded hover:bg-primary-100 group dark:text-gray-200 dark:hover:bg-gray-700"
