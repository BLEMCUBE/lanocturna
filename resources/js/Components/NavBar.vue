<template>
    <nav class="fixed top-0 z-50 w-full bg-primary-900 border-b border-primary-900 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-2 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
                        type="button"
                        class="inline-flex items-center p-2 text-sm text-white rounded sm:hidden hover:bg-primary-100 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700">
                        <span class="sr-only">Open sidebar</span>
                        <i class="fas fa-bars fa-2x"></i>
                    </button>
                    <Link :href="route('inicio')" class="flex ml-3 dark:fill-white">
                        <img class="mx-auto h-10 w-auto" :src="Logo" alt="Imagen" />
                    </Link>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center ml-3">
                        ...
                        <div id="tooltip-toggle" role="tooltip"
                            class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded shadow-sm opacity-0 tooltip">
                            {{ !isDark ? 'Modo Oscuro' : 'Modo Claro' }}

                            <div class="tooltip-arrow" data-popper-arrow></div>
                        </div>
                        <p class="text-sm font-medium text-white truncate dark:text-gray-300 ml-5" role="none">
                        ...
                        <div class="flex items-center ml-3">
                            <div>
                                <button type="button" class="flex text-sm bg-gray-800 rounded-full" aria-expanded="false"
                                    ...
                                    <img class="w-8 h-8 rounded-full border-2 border-white" :src="$page.props.auth.user.photo" alt="user photo">
                                </button>
                            </div>
                            <!-- Dropdown menu -->
