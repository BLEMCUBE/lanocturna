...
const titulo = `ML Productos Vendidos`
				...
				<div class="w-full  flex items-center min-h-full p-2">
					<div class="container max-w-4xl">
						<div class="bg-white rounded shadow-md overflow-hidden">
							...
							<DataTable :filters="filters" sortField="item_sku" :sortOrder="-1"
								v-bind:rowClass="rowClass" :value="datosFinal.data" scrollable paginator :rows="50" :pt="{
								...
								<Column field="item_sku" header="SKU" sortable :pt="{
									bodyCell: {
