...
const selectedEstado = ref({ name: 'INGRESADO', code: 'INGRESADO' });
const estados = ref([
...
<template>
    ...
    <AppLayout :pagina="[{ 'label': 'RMA', link: false, url: route(ruta + '.index') }, { 'label': titulo, link: false }]">
        <!--Contenido-->
        <div
            class="grid grid-cols-12 p-0 m-0 gap-4 mb-4 bg-white col-span-12 py-2 rounded-lg shadow-lg lg:col-span-12 2xl:col-span-10 dark:border-gray-700  dark:bg-gray-800">
