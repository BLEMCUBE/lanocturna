...
<template>
    <div>
        ...
        <AuthenticatedLayout :pagina="[{'label':  titulo,link:false }]">
            <div
                class="card px-4 py-3 mb-4 bg-white col-span-12 pb-5 rounded-lg shadow-sm 2xl:col-span-12 dark:border-gray-700  dark:bg-gray-800">
                <!--Contenido-->
                ...
                <div class="overflow-x-auto">
                    <div class="inline-block min-w-full  mt-4 align-middle">
                        <div class="overflow-hidden">
                            ...
                            <div class="card">
                                <DataTable :rowClass="rowClass" showGridlines  size="small" v-model:filters="filters" :value="customers" paginator :rows="10"
