...
const submit = () => {
    ...
    form.post(route(ruta + '.store'), {
        ...
        forceFormData: true,
        onSuccess: () => {
            show('success', 'Mensaje', 'Importacion bultos creado')
            setTimeout(() => {
...
<template>
    ...
    <AppLayout
        ...
        <div
            class="card px-4 py-3 mb-4 bg-white col-span-12 py-5 rounded-lg shadow-lg lg:col-span-12 dark:border-gray-700  dark:bg-gray-800">
            ...
            <!--Modal productos-->
            <Dialog v-model:visible="isShowModalProducto" modal :style="{ width: '25vw' }" :pt="{
                header: {
