...
const MyDesignSystem= {
    datatable: {
        ...
        header: ({ props }) => ({
            class: [
                'bg-white text-slate-700 border-gray-300 font-bold p-4',
                'dark:border-blue-900/40 dark:text-white/80 dark:bg-gray-900', // Dark Mode
                //props.showGridlines ? 'border-x border-t border-b-0' : 'border-y border-x-0'
                props.showGridlines ? 'border-0' : 'border-0'
            ]
        }),
        ...
        column: {
            headercell: ({ context, props }) => ({
                class: [
                    ...
                    context.sorted ? 'bg-secondary-100 text-blue-700' : 'bg-secondary-100  text-slate-700', // Sort
                    context.sorted ? 'dark:text-white/80 dark:bg-blue-300' : 'dark:text-white/80 dark:bg-gray-900', // Dark Mode
                    {
                        ...
                        'border-0': context?.showGridlines,
                        //'overflow-hidden space-nowrap border-y relative bg-clip-padding': context.resizable // Resizable
                        'overflow-hidden space-nowrap border-0 relative bg-clip-padding': context.resizable // Resizable
                    }
                ]
            }),
