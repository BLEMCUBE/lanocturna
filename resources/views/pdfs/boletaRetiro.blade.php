...
<body>
    <div style="text-align: center">
        ...
        <table border="0" cellpadding=0 cellspacing=0 class='tg' style="margin: 0 auto;">
            ...
            <tr class="fs-10">
                <td class="ba tg-left" colspan="3">Cédula de identidad: <b class="fs-12">{{$data["cliente_ci"]}}</b></td>
                <td class="ba" colspan="2">Teléfono: <b class="fs-12">{{$data["cliente_telefono"]}}</td>
            </tr>

            <tr class="fs-10">
                <td class="ba tg-left" colspan="3">Dirección: <b class="fs-12">{{$data["direccion"]}} {{$data["nro_casa"]}}</b></td>
                <td class="ba" colspan="2">Localidad: <b class="fs-12">{{$data["localidad"]}}</b></td>
            </tr>
